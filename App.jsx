...
//     // Listen when user taps on a notification
//     const responseSubscription =
//       Notifications.addNotificationResponseReceivedListener((response) => {
//         console.log("User tapped notification:", response);
//         // You could navigate based on the notification data here
//       });
...
//       // Normalize to always get a string
//       const incomingUrl =
//         typeof event === "string"
//           ? event
...
//   //       if (sessionId && !deepLinkHandled) {
//   //         console.log(
//   //           "Processing payment success deep link with session:",
//   //           sessionId
//   //         );
//   //         setDeepLinkHandled(true);
...
//         // Set pending payment to trigger navigation
...
//         // Check if the payment data is not too old (2 hours max)
...
//           // Don't remove the payment data if it's a network error
//         }
//       }
//     } catch (error) {
...
//   useEffect(() => {
//     // Only check for pending payment if not handling a deep link
//     if (!deepLinkHandled) {
//       checkPendingPayment();
//     }
...
//                   ? 2 * 60 * 60 * 1000
//                   : 24 * 60 * 60 * 1000; // 2 hours for pending, 24 hours for recent deliveries
...
//     // Track when MainApp becomes active
...
//   // Clear pending payment handler
//   const handlePaymentProcessed = () => {
//     console.log("Payment processed, clearing pending payment");
//     setPendingPayment(null);
//     setDeepLinkHandled(false); // Reset for next payment
//   };
...
//     <StripeProvider
//       publishableKey={
//         process.env.STRIPE_PUBLISHABLE_KEY || "my_test_publishable_key"
//       }
//       merchantIdentifier="merchant.com.rapiddelivery" // For Apple Pay
//     >
//       <LoadingProvider>
//         <NavigationContainer
//           ref={navigationRef}
